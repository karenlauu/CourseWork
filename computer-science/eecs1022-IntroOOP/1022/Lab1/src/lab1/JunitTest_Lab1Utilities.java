...
public class JunitTest_Lab1Utilities {
	...
	public void test_02_11_() {
		double x=55.5;
		String result= Lab1Utilities.temperatureConverter(x);
		String expect = "Fahrenheit (55.5) is equivalent to (13.06) in Celsius";
		String str = String.format("\nTest temperatureConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);
	...
	public void test_02_12_() {
		double x=-1.5;
		String result= Lab1Utilities.temperatureConverter(x);
		String expect = "Fahrenheit (-1.5) is equivalent to (-18.61) in Celsius";
		String str = String.format("\nTest temperatureConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);
	...
	public void test_02_13_() {
		double x=1.578;
		String result= Lab1Utilities.temperatureConverter(x);
		String expect = "Fahrenheit (1.578) is equivalent to (-16.90) in Celsius";
		String str = String.format("\nTest temperatureConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);
	...
	@Test
	public void test_03_16_() {
		int  x=396;
		String result= Lab1Utilities.ageInYearsDetailed(x);		
		String expect = "Age in days (396), age in years is (1), months (1), with remaining days (1)";
		String str = String.format("\nTest ageInYearsDetailed fail for (%d) Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);
		assertEquals(str, expect,result);		
	}
	...
	public void test_04_12() {
		double  x=30.48;
		String result= Lab1Utilities.distanceConverter(x);
		String expect = "30.48cm is 1ft and 0.00in";		
		String str = String.format("\nTest distanceConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);		
		assertEquals(str, expect,result);		
	}
	...
	public void test_04_13() {
		double  x=33.02;
		String result= Lab1Utilities.distanceConverter(x);
		String expect = "33.02cm is 1ft and 1.00in";		
		String str = String.format("\nTest distanceConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);		
		assertEquals(str, expect,result);		
	}
	...
	public void test_04_15() {
		double  x=123.456;
		String result= Lab1Utilities.distanceConverter(x);
		String expect = "123.46cm is 4ft and 0.60in";		
		String str = String.format("\nTest distanceConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);		
		assertEquals(str, expect,result);		
	}
	...
	public void test_04_16() {
		double  x=123.452;
		String result= Lab1Utilities.distanceConverter(x);
		String expect = "123.45cm is 4ft and 0.60in";		
		String str = String.format("\nTest distanceConverter fail for (%.2f)  Returned ( %s ), but correct is ( %s )\n",
				x, result, expect);		
		assertEquals(str, expect,result);		
	}
	...
	public void test_05_10() {
		double x=4055.55, y = 1.5;
		String result= Lab1Utilities.fiveYearBalance(x,y);
		String expect = "The balance was 4055.55 with interest 1.50, after five years balance is 4368.98";
		String str = String.format("\nTest fiveYearBalance fail for Balance=%.2f and Interest=%.2f Returned ( %s ), but correct is ( %s )\n",
				x,y, result, expect);
		assertEquals(str, expect,result);		
	}
	...
	public void test_06_07() {
		int pounds = 1, feet =0,inches=1;
		
		
		double result= Lab1Utilities.computeBMI(pounds, feet, inches);
		double expect = 703.07;
		String str = String.format("\nTest computeBMI fail for pounds=%d, feet=%d,inches=%d  Returned ( %.4f ), but correct is ( %.4f )\n",
				pounds,feet ,inches,	 result, expect);
		final double THRESHOLD = .05;
		assertTrue(str, Math.abs(expect - result) < THRESHOLD);
	...
	@Test
	public void test_06_9() {
		int pounds = 1, feet =1,inches=1;
