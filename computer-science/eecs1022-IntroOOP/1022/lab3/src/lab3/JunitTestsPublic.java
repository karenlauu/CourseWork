...
public class JunitTestsPublic {
	...
	@Test
	public void test_pb_04_02() {
		
		double [][] data = {{0.2,0.3,0.5}, {0.4,0.4,0.2}, {0.4,0.3,0.3}};
		
		assertTrue("Test pb_04_02 failed.", TwoDArrayProblems.isMarkovMatrix(data));
	}	
	@Test
	public void test_pb_04_03() {
		
		double [][] data = {{0.3,0.3,0.5}, {0.4,0.4,0.2}, {0.4,0.3,0.3}};
		
		assertFalse("Test pb_04_03 failed.", TwoDArrayProblems.isMarkovMatrix(data));
	}	
	...
	public void test_pb_05_02() {
		...
		double [][] data = {{0.0, 0.0}, {0.0, 3.0}, {4.0, 0.0}, {4.0, 3.0} };
		double [][] correctOut = {{0.0, 3.0, 4.0, 5.0}, {3.0, 0.0, 5.0, 4.0}, {4.0, 5.0, 0.0, 3.0}, {5.0, 4.0, 3.0, 0.0}};
	...
	public void test_pb_05_03() {
		...
		double [][] data = {{1.0,2.0}, {3.0,2.0}, {2.0,2.0}};
		double [][] correctOut = {{0.0, 2.0, 1.0}, {2.0, 0.0, 1.0}, {1.0, 1.0, 0.0}};
		
		assertArrayEquals("Test pb_05_03 failed.", correctOut,TwoDArrayProblems.findDistances(data));
	}
