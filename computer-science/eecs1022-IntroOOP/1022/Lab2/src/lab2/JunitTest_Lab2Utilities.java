...
public class JunitTest_Lab2Utilities {
	...
	public void test_04_09_() {
		String s1 = "Testing" , s2 = "Test",  s3 = "A";
	    String result = Lab2Utilities.mixStrings(s1, s2, s3);
	    
	    assertEquals("TeststststAAAAA", result);
	}

	@Test
	public void test_04_10_() {
	    String s1 = "Hello" , s2 = "",  s3 = "Hi";
	    String result = Lab2Utilities.mixStrings(s1, s2, s3);
	...
	@Test
	public void test_04_11_() {
	    String s1 = "Potato" , s2 = "Sa",  s3 = "La";
	    String result = Lab2Utilities.mixStrings(s1, s2, s3);
	    
	    assertEquals("PotSaSaSaLaLaLaLaLa", result);
	}
	...
	@Test
	public void test_05_08_() {
		String inputStr = "sa123";
	...
	@Test
	public void test_05_09_() {
		String inputStr = "AAaaAA";
		String expected = "A2a2A2";
		String result = Lab2Utilities.stringCompressor(inputStr);
	...
	@Test
	public void test_06_11_() {
	    short x = -1191;
	    String result = Lab2Utilities.binaryRepresentation(x);
	    String expect = "Invalid input. Input a non-negative short value.";
	    String str = String.format("\nTest binaryRepresentation fail for (%d)  Returned (%s), but correct is (%s)\n",
	            x, result, expect);
	...
	@Test
	public void test_06_12_() {
	    short x = 32767;
	    String result = Lab2Utilities.binaryRepresentation(x);
	    String expect = "The decimal value (32767) has binary representation [0111111111111111]";
	    String str = String.format("\nTest binaryRepresentation fail for (%d)  Returned (%s), but correct is (%s)\n",
	            x, result, expect);
	...
	public void test_07_14_() {
	    int x = -5, y = 7;
	    String result = Lab2Utilities.countofMult357(x, y);
	    String expect = "Invalid input, inputs should be non-negative values.";
	    String str = String.format("\nTest countofMult357 fail for (%d) and (%d) Returned (%s), but correct is (%s)\n",
	            x, y, result, expect);
	...
	@Test
	public void test_09_08_() {
	    short v1 = -5;
	    short v2 = 0;

	    String result = Lab2Utilities.binaryXor(v1, v2);

	    String expect = "Invalid input(s). Input a non-negative short value.";
	    String str = String.format("\nTest binaryXor fail for (%d) and (%d)  Returned (%s), but correct is (%s)\n",
	            v1, v2, result, expect);
	...
	@Test
	public void test_09_11_() {
	    short v1 = 32767;
	    short v2 = 32766;

	    String result = Lab2Utilities.binaryXor(v1, v2);

	    String expect = "XOR of two values is [0000000000000001]";
	    String str = String.format("\nTest binaryXor fail for (%d) and (%d)  Returned (%s), but correct is (%s)\n",
	            v1, v2, result, expect);
