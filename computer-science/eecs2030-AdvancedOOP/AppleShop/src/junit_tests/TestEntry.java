...
import model.*; //imports all classes in model
...
public class TestEntry {
	...
	public void test_entry_1() {
		...
		//assertTrue(e.getSerialNumber(), "F9DN4NKQ1GC"); // not truly what we want to test
		assertEquals("F9DN4NKQ1GC", e.getSerialNumber());
		assertTrue(e.getProduct() == p);
		assertSame(e.getProduct(), p); // are they referring the the same Product object(same product address)
