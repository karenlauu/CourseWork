...
public class TestProduct {
	...
	public void test_product_1() {
		...
		//Think each assertion is to verify the ACTUAL value of method call against its EXPECTED value.
		 ...
		 * Instead, we should allow for some tolerance OF CALCULATED RESLTS (E.G. +/- 0.1)
		 */
		assertEquals(0.0, p.getOriginalPrice(), 0.1);
		//assertTrue(0.0==p.getOriginalPrice()); // not recommended for double values - should allow tolerance
	...
	//	assertTrue(p.getModel()== "iPad Pro 12.9"); //this is not recommended - checks string address
