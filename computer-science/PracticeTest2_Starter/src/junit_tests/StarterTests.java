 ...
 * Problem:
 * 
 * – You are required to implement a small retail store of computer products.
 * 	+ Each retail store maintains stocks of different products,
 * 		and the store allows submissions of orders by customers.
 * 	+ A submission of order may succeed (if there's enough stock) or fail.
 * 
 * - There are three classes to develop: 
 * 		+ CustomerProfile
 * 		+ RetailStore
 * 		+ StoreManager
 * - There are two exception classes to define:
 * 		+ InvalidProductKindException
 * 		+ InsufficientStockException
 * 
 * - See comments within each test method to infer what's to be implemented. 
 */
...
public class StarterTests {
	...
	public void test_customer_profile_02b() { 
		...
		/*
		 * Here the starter test only covers 2 kinds of the possible products.
		 * You may want to test on your own to make sure that other kinds of product also work.
		 */
	}
	...
	public void test_store_manager_02() {
		...
		/*
		 * Question: do the above 4 manager variables store different addresses?
		...
		/*
		 * Question: which version of the equals method will be invoked? 
		 */
